...
javac -encoding utf-8 -Xlint:unchecked -Xlint:deprecation -classpath android.jar:android-support-v4.jar:nanohttpd-2.3.1.jar:fastjson-1.2.9.jar:org.apache.http.legacy.jar -d classes @sources.txt
